...
export default function RegisterPage() {
    ...
    return (
        <>
            <SEO
                title="Create an Account - YenFlowers"
                description="Sign up to enjoy exclusive offers and a faster checkout experience."
            />
                    ...
                    <div className="mx-auto w-full max-w-md">
                        ...
                        <div className="mb-8 flex flex-col gap-3">
                            ...
                            <p className="text-base text-muted-foreground">
                                Sign up to enjoy exclusive offers and a faster checkout.
                            </p>
                        </div>
